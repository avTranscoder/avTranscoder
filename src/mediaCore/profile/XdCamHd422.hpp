...
void loadXdCamHD422( Profile::ProfilesDesc& profiles )
{
	...
	xdCamHd422[ constants::mediaProfileIdentificator ] = "xdcamhd422";
	xdCamHd422[ constants::mediaProfileIdentificatorHuman ] = "XdCamHD 422";
	xdCamHd422[ constants::mediaProfileType ] = constants::mediaProfileTypeVideo;


	xdCamHd422[ constants::mediaProfileCodec ] = "mpeg2video";
	...
	xdCamHd422[ constants::mediaProfileFrameRate ] = "25";

	xdCamHd422[ constants::mediaProfilePixelFormat ] = "yuv422p";
