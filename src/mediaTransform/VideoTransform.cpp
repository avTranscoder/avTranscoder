...
bool VideoTransform::init( const mediacore::Frame& srcFrame, const mediacore::Frame& dstFrame )
{
	const mediacore::VideoFrame& src = static_cast<const mediacore::VideoFrame&>( srcFrame );
	const mediacore::VideoFrame& dst = static_cast<const mediacore::VideoFrame&>( dstFrame );
...
void VideoTransform::convert( const mediacore::Frame& srcFrame, mediacore::Frame& dstFrame )
{
	const mediacore::VideoFrame& src = static_cast<const mediacore::VideoFrame&>( srcFrame );
	mediacore::VideoFrame& dst = static_cast<mediacore::VideoFrame&>( dstFrame );
