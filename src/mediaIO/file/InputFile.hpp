...
public:
	...
	**/
	 ...
	 **/
	InputFile& analyse( mediacore::IProgress& progress, const EAnalyseLevel level = eAnalyseLevelFull );
	 ...
	 * @return structure of media metadatas
	 **/
	static Properties analyseFile( const std::string& filename, mediacore::IProgress& progress, const EAnalyseLevel level = eAnalyseLevelFull );
	 ...
	 */
	virtual void setProfile( const mediacore::Profile::ProfileDesc& desc );
