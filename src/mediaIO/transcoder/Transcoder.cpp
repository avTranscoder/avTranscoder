...
void Transcoder::add( const std::string& filename, const size_t streamIndex, const std::string& profileName, const size_t offset )
{
	...
	mediacore::Profile::ProfileDesc& transcodeProfile = _profile.getProfile( profileName );
...
void Transcoder::add( const std::string& filename, const size_t streamIndex, mediacore::Profile::ProfileDesc& profileDesc, const size_t offset )
{
...
void Transcoder::add( const std::string& filename, const size_t streamIndex, mediacore::Profile::ProfileDesc& profileDesc, ICodec& codec, const size_t offset )
{
	_profile.update( profileDesc );
	if( ! filename.length() )
	{
...
void Transcoder::add( const std::string& filename, const size_t streamIndex, const int subStreamIndex, mediacore::Profile::ProfileDesc& profileDesc, const size_t offset )
{
	_profile.update( profileDesc );
...
void Transcoder::add( const std::string& filename, const size_t streamIndex, const int subStreamIndex, mediacore::Profile::ProfileDesc& profileDesc, ICodec& codec, const size_t offset )
{
	_profile.update( profileDesc );
...
void Transcoder::process( mediacore::IProgress& progress )
{
	size_t frame = 0;
	...
	while( 1 )
	{
		...
		if( progress.progress( 1 / _outputFps * ( frame ), totalDuration ) == mediacore::eJobStatusCancel )
		{
			break;
		}
...
void Transcoder::addTranscodeStream( const std::string& filename, const size_t streamIndex, mediacore::Profile::ProfileDesc& profile, const size_t offset )
{
	InputFile* referenceFile = addInputFile( filename, streamIndex );
...
void Transcoder::addTranscodeStream( const std::string& filename, const size_t streamIndex, const size_t subStreamIndex, mediacore::Profile::ProfileDesc& profile, const size_t offset )
{
	InputFile* referenceFile = addInputFile( filename, streamIndex );
...
void Transcoder::addDummyStream( const mediacore::Profile::ProfileDesc& profile, const ICodec& codec )
{
	using namespace mediacore::constants;
	if( ! profile.count( mediaProfileType ) )
