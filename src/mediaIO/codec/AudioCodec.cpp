...
mediacore::AudioFrameDesc AudioCodec::getFrameDesc() const
{
	assert( _codecContext != NULL );
	mediacore::AudioFrameDesc audioFrameDesc;
...
void AudioCodec::setAudioParameters( const mediacore::AudioFrameDesc& audioFrameDesc )
{
