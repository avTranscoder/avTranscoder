...
mediacore::VideoFrameDesc VideoCodec::getVideoFrameDesc() const
{
	assert( _codecContext != NULL );
	mediacore::VideoFrameDesc VideoFrameDesc;
	mediacore::Pixel pixel( _codecContext->pix_fmt );
...
void VideoCodec::setImageParameters( const mediacore::VideoFrameDesc& videoFrameDesc )
{
	setImageParameters( videoFrameDesc.getWidth(), videoFrameDesc.getHeight(), videoFrameDesc.getPixelDesc() );
}


void VideoCodec::setImageParameters( const size_t width, const size_t height, const mediacore::Pixel& pixel )
{
