...
bool AvInputAudio::readNextFrame( mediacore::Frame& frameBuffer )
{
	if( ! getNextFrame() )
		return false;
	...
	mediacore::AudioFrame& audioBuffer = static_cast<mediacore::AudioFrame&>( frameBuffer );
...
bool AvInputAudio::readNextFrame( mediacore::Frame& frameBuffer, const size_t subStreamIndex )
{
	if( ! getNextFrame() )
		return false;
